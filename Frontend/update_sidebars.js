...
const targetDirs = [
    'Analytics', 'Complain', 'Inventory', 'Query', 'smartexpiry', 'Udhaar', 'Settings', 'Employees', 'leave'
];
...
let sidebarTemplateHtml = `
            ...
            <nav class="sidebar-menu">
                ...
                <a href="../leave/leave.html" class="menu-item __LEAVE_ACTIVE__" title="Staff Leaves">
